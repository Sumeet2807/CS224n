...
class NMT(nn.Module):
    ...
    def __init__(self, word_embed_size, hidden_size, vocab, dropout_rate=0.3, no_char_decoder=False):
        ...
        self.encoder = torch.nn.LSTM(word_embed_size,hidden_size,bidirectional=True)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        X = torch.nn.utils.rnn.pack_padded_sequence(self.model_embeddings_source(source_padded),source_lengths)
